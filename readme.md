...
2: Click the "**Install IceShield**" button to install the script!
    [![Install IceShield](https://img.shields.io/badge/Install%20IceShield-Userscript-blue?logo=Tampermonkey)](https://cdn.jsdelivr.net/gh/kirbysoftware/iceshield@main/IceShield-V1.0.user.js)
